class ApiConstant{
  static String registerEndPoint = 'user/register';
  static String loginEndPoint = 'user/login';
  static String loginTeacherEndPoint = 'teacher/login';
  static String studentProfileEndPoint = 'user/profile';
  static String logoutEndPoint = 'user/logout';
