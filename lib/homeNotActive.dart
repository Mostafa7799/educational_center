                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          children: [
                            Padding(
                              ...
                              child: Text("Welcome ${useer[1]['username']}", style: TextStyle(fontWeight: FontWeight.w500,fontSize: 14),),
                            ),
                        ...
                        Row(
                          children: [
                            Padding(
                              ...
                              child: Text("Pending...waiting for activation",style: TextStyle(color: Color(
                                  0xFFD1002B),fontSize: 14),),
                            ),
                        ...
                        SizedBox(width: 500,
                            height: 350,
                            child: Image.asset('assets/images/1.png',bundle: null,)),
                        Divider(
                          thickness: 1,
                          color: Colors.black,
                        ),
