...
class Custom_Button extends StatelessWidget {
  ...
  Custom_Button({required this.text, required this.icon, required this.onpressed});
          ...
          Row(
            children: [
              SizedBox(
                  width : 70,
                  height: 70 ,
                  child: IconButton( icon: new Image.asset(icon), onPressed: onpressed ,))
            ],
  ...
  Widget build(BuildContext context) {
    ...
    return
      SizedBox(
          width : 35,
          height: 35 ,
          child: IconButton( icon: new Image.asset(icon), onPressed: () {  },));;
  }
