                                                  ...
                                                  child: Row(
                                                    children: [
                                                      ...
                                                      Column(
                                                        children: [
                                                          Padding(
                                                            padding: const EdgeInsets.only(right: 100, top: 14,bottom: 4),
                                                            child: Row(
                                                          children:[
                                                            Text("Quiz 2", style: TextStyle(fontSize: 20,fontWeight: FontWeight.w500),),
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Row(
                                                                children:[
                                                                  Text("2019-2323-2323", style: TextStyle(fontSize: 20,fontWeight: FontWeight.w500),),
