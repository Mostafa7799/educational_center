                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(children: [
                        Text("MohamedHassan",style:TextStyle(color:Colors.white,fontSize: 15,fontWeight: FontWeight.w400) ,),
                        Text("@Username",style: TextStyle(color:Colors.white,fontSize: 15,fontWeight: FontWeight.w400))
                      ],),
                    ),
                      ...
                      content: SingleChildScrollView(
                        ...
                        child: Container(
                          ...
                          child: Column(children: [
                                ...
                                child: DropdownButtonFormField<String>(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    focusedBorder: OutlineInputBorder(
                                        borderSide: BorderSide(width: 1.5,color: Colors.yellowAccent),
                                        borderRadius: BorderRadius.circular(30)
                                    ),
                                  ),
                            ...
                            CustomTextField(hint: 'Your School', icon1:Icons.school_outlined,
                              controller:school,
                            ),
                            CustomTextField(
                              controller: email,
                              hint: 'Your Email@gmail.com', icon1:Icons.email_outlined,
                            ),
                            CustomTextField(
                              controller:phone ,
                              hint: 'Your Phone', icon1:Icons.phone_android_sharp,
                            ),
                            CustomTextField(
                              controller: birthday,
                              hint: 'Your Birthday', icon1:Icons.date_range,
                            ),
          ...
          Column(
            children: [
              ...
              Padding(
                ...
                child: Text("Email:",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w400),),
              ),
              CardInfo(
              ...
              Padding(
                ...
                child: Text("PhoneNamber:",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w400),),
              ),
              CardInfo(
              ...
              Padding(
                ...
                child: Text("Birthday:",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w400),),
              ),
              CardInfo(
...
class CustomTextField extends StatelessWidget {
  ...
  CustomTextField({required this.hint,required this.icon1,required this.controller});
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 8.0),
                child: Text(text,style: TextStyle(fontSize: 20,fontWeight: FontWeight.w400,color: Colors.black),),
              ),
            ],
          ),
        ),
